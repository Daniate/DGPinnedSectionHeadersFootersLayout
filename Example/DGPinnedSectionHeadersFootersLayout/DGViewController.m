...
//
//  Created by Daniate on 06/12/2016.
//  Copyright (c) 2016 Daniate. All rights reserved.
//

#import "DGViewController.h"
#import <DGPinnedSectionHeadersFootersLayout/DGPinnedSectionHeadersFootersLayout.h>
#import "CollectionViewCell.h"
#import "CollectionHeaderFooterView.h"

@interface DGViewController () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
- (void)viewDidLoad
{
    ...
    DGPinnedSectionHeadersFootersLayout *lyt = [[DGPinnedSectionHeadersFootersLayout alloc] init];
...
- (IBAction)adjustScrollDirection:(UISegmentedControl *)sender {
    DGPinnedSectionHeadersFootersLayout *lyt = (DGPinnedSectionHeadersFootersLayout *)self.collectionView.collectionViewLayout;
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout*)collectionViewLayout referenceSizeForHeaderInSection:(NSInteger)section {
    DGPinnedSectionHeadersFootersLayout *lyt = (DGPinnedSectionHeadersFootersLayout *)collectionViewLayout;
